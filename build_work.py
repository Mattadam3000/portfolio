...
def section(s):
    ...
    if s.get('projects'):
        ...
        gallery_class = 'gallery feature-gallery' if s.get('layout') == 'feature' else 'gallery'
        parts.append(gallery(s['images'], s['title'], gallery_class))
